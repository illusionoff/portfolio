      ...
      <div className="container">
        ...
        <div className="card">
          <div className="card-content">
            ...
            <h6>Основные функции сервиса</h6>
            <ul>
              <li>Получение данных котировок в реальном времени по спотовому рынку выбранной криптовалюты с бирж Gate.io и Bithamb.pro</li>
              <li>Получение данных по комиссиям криптобиржи   Bithamb.pro запись данных в .csv файл о котировках, дополнительных параметрах</li>
              <li>Активация записи данных в .csv файл по заданному значению необходимой прибыли  и выбор направления торговли</li>
              <li>Сбор статитстики и анализ скорости поступления сигналов с биржи Bithamb.pro</li>
