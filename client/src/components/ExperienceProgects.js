            ...
            <div className="container">
                <div className="card">
                    <div className="card-content">
                        ...
                        <p>
                            <em className="gray-text">HomeMoneyCalc. Сервис позволяющий вести учет расходов и доходов</em>
                        </p>
                        ...
                        <ul className="border-bottom">
                            <li>Nodejs, Express, MongoDB, mongoose, handlebars, materializecss, mocha, eslint, prettier, passport.js  </li>
                        </ul>
                        <h6 >Дополнительные технологии, библиотеки</h6>
                        {/* <ul className="border-bottom">
                            <li>express-validator	валидация форм </li>
                            <li>winston	логирование</li>
                            <li>helmet	защита приложений express через различные заголовки HTTP</li>
                            <li>nodemailer	отправка почты</li>
                            <li>csurf	для защиты сеансов сессии от подделки- взлома</li>
                            <li>connect-mongodb-session	для хранения сеансов в MongoDB</li>
                            <li>bcrypt	хеширования паролей</li>
                            <li>crypto	хеширования строки для изменения забытого пароля</li>
                            <li>connect-flash	для хранения и передачи сообщений</li>
                            <li>moment-timezone	поддержка часовых поясов IANA для Moment.js</li>
                            <li>nodemon	автоматического перезапуска проекта при изменении файлов проекта в dev</li>
                            <li>underscore	библиотека функций. Использую для проверки на корректную дату _.isDate(date)</li>
                            <li>fontawesomecom иконки</li>
                            <li>chart.js диаграммы</li>
                        </ul> */}
